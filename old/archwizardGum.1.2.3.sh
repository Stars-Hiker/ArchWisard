...
# =============================================================================
show_banner() {
    # No `clear` here — if gum crashes right after, the screen would be blank
    # and the error message invisible. Print a plain marker first so we know
    # the script reached this point even if gum fails.
